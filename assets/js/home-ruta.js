        ...
        .then(function (data) {
            ...
            return fetchPromise.then(function (postMap) {
                    ...
                    var i18n = {
                        ...
                        en: { texts: 'texts', eyebrow: 'This week', title: 'Reading routes', sub: 'If this is your first time at 421, here\u2019s a path to start reading.', cta: 'Explore all 7 routes', href: '/en/routes/' },
                        pt: { texts: 'textos', eyebrow: 'Esta semana', title: 'Rotas de leitura', sub: 'Se \u00e9 a sua primeira vez no 421, aqui est\u00e1 um caminho para come\u00e7ar.', cta: 'Explorar as 7 rotas', href: '/pt/rutas/' },
                        fr: { texts: 'textes', eyebrow: 'Cette semaine', title: 'Parcours de lecture', sub: 'Si c\u2019est votre premi\u00e8re visite au 421, voici un chemin pour commencer.', cta: 'Explorer les 7 parcours', href: '/fr/rutas/' },
                        zh: { texts: '\u7bc7', eyebrow: '\u672c\u5468', title: '\u9605\u8bfb\u8def\u7ebf', sub: '\u5982\u679c\u4f60\u662f\u7b2c\u4e00\u6b21\u6765\u5230421\uff0c\u8fd9\u91cc\u6709\u4e00\u6761\u5f00\u59cb\u9605\u8bfb\u7684\u8def\u5f84\u3002', cta: '\u63a2\u7d22\u5168\u90e87\u6761\u8def\u7ebf', href: '/zh/rutas/' },
                        ja: { texts: '\u8a18\u4e8b', eyebrow: '\u4eca\u9031', title: '\u8aad\u66f8\u30eb\u30fc\u30c8', sub: '421\u304c\u521d\u3081\u3066\u306a\u3089\u3001\u3053\u3053\u304b\u3089\u8aad\u307f\u59cb\u3081\u307e\u3057\u3087\u3046\u3002', cta: '7\u3064\u306e\u30eb\u30fc\u30c8\u3092\u63a2\u7d22', href: '/ja/rutas/' },
                        ko: { texts: '\uae00', eyebrow: '\uc774\ubc88 \uc8fc', title: '\ub9ac\ub529 \ub8e8\ud2b8', sub: '421\uc774 \ucc98\uc74c\uc774\ub77c\uba74, \uc5ec\uae30\uc11c \uc77d\uae30 \uc2dc\uc791\ud558\uc138\uc694.', cta: '7\uac1c \ub8e8\ud2b8 \ud0d0\uc0c9', href: '/ko/rutas/' },
                        tr: { texts: 'yaz\u0131', eyebrow: 'Bu hafta', title: 'Okuma rotalar\u0131', sub: '421\u2019e ilk kez geliyorsan\u0131z, i\u015fte ba\u015flamak i\u00e7in bir yol.', cta: '7 rotay\u0131 ke\u015ffet', href: '/tr/rutas/' }
                    };
